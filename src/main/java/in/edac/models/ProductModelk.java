...
public class ProductModelk {
	...
	public ProductModelk() {
		...
		this.products.add(new Product("k04", " HP K1500 Wired Multi-device Keyboard", "k4.jpeg", 629 ));
		...
		this.products.add(new Product("k12", "  Glink Rainbow Multi-device Keyboard ", "k12.jpeg",  829.00));
	}
