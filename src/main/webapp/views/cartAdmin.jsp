			...
			<div id="content">
				...
				<div class="container-fluid p-0 px-lg-0 px-md-0">
					...
					<nav class="navbar navbar-expand navbar-light my-navbar">
						...
						%>
						<h5 class="ml-3">Welcome, ${sessionScope.adminname }</h5>

						<ul class="navbar-nav ml-auto">
							<li class="nav-item dropdown"><a
								class="nav-link dropdown-toggle" href="#" id="userDropdown"
								role="button" data-toggle="dropdown"> <span
									style="color: black;font-family: 'Font Awesome 5 Free';
    font-size: 19px;"><b>Fly Buy Mart</b></span> <img
						...
						<br> <a href="${pageContext.request.contextPath }/logout"
							class="btn btn-outline-secondary mr-3" style="border-radius: 26px;">Logout</a>
					</nav>
					<!-- End of Topbar -->
