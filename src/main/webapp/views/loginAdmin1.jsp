...
<div class="container" style="height:68vh;">
  <div class="container d-flex justify-content-center">
    ...
    <form method="POST" action="http://localhost:8080/user/loginAdmin1" class="form-signin">
      ...
      <div class="form-group text-light ${error != null ? 'has-error' : ''}">
        <span>${message}</span> <br />
        
        <input name="adminname" type="text"
          class="form-control" placeholder="Admin name" autofocus="true" style="width:389px"/> 
          <br />
          <input
          name="password" type="password" class="form-control "
          placeholder="Password" style="width:389px"/> <br /><span>${error}</span> 
